...
class SolarPanel:
    ...
    def load_model(self, model_name):
        ...
        """
        if model_name:
            model = torch.hub.load('C:/Users/darkr/Desktop/bütün kodlar/gt/görüntü işleme ve hasar tespiti/görüntü işleme son/yolov5', 'custom', path=model_name,source='local')
...
detector = SolarPanel(capture_index=0, model_name='C:/Users/darkr/Desktop/bütün kodlar/gt/görüntü işleme ve hasar tespiti/görüntü işleme son/yeni_modeln_n.pt',z=0)
detector()

# sleep(1)
# # gorev(40.7690175, 30.3689736, 40.7688367, 30.3689910, 40.7690266, 30.3691238, 40.7688479, 30.3691520)
# x=print(send_txt.send_with_tcP())
# print("x:",x)
# sonuç=send_txt.send_with_tcP()
# print(sonuç)

# send_photo.send_with_tcp()
# sleep(1)
